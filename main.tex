...
Any audio similarity measures may be used as a loss functions and performance measure; however, the two terms are given to distinct functions in the sound-matching framework. A loss function guides the generative process by giving feedback after every optimization step. A performance measure sits outside of the generative process, and is only meant to be an objective measure of success, or a replacement for manual listening tests. We will discuss the sound-matching framework in the following section.
