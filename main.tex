...
Moderate to strong correlation was observed between the listeners' likert scores, using speraman's rank correlation test~\cite{spearman1987proof}. This strengthens our confidence in using human assigned scores as the ground truth. Figure~\ref{tab:listener_correlation} shows the individual and overall $\rho$ and p-values.
