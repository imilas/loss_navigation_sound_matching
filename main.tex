...
\begin{figure*}[t]
  ...
  \begin{minipage}[t]{\textwidth}
    ...
    \end{minipage}
  \end{minipage}
  \caption{Bootstrapped distributions and ranks for non-delayed and randomly delayed pitch-bend programs. \todo{It's strange that in-domain has lower performance scores than delayed pitch-bend}}
