...
\section{methodology}
The foundation of our experiments is iterative loop shown in Figure~\ref{fig:sound_design_loop_iterative}. This iterative approach is the adaption of the in-domain experiments by Salimi \textit{et al.}~\cite{salimi2025evaluating}. The experimetns 
