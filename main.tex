...
To define an experiment the values of loss function $L$, $g^t$, $g$, and max number of iterations $n$ are fixed. Each experiment has three phases
\begin{enumerate}
    ...
    \item After $n$ number of iterations, the success of the experiment is measured by comparing the $x^t$ to the final output of the synthesizer.
\end{enumerate}
